...
public class Empleados extends javax.swing.JFrame {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        ResultSet rs=sql.consultarDatos(estSQL1, "select * from empleado");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        {   
            ...
            if(valorO==null)
            {
                String sentenciaSQL="Insert into empleado values('"+txtId_empleado.getText().trim()+"','"+txtNombre_Empleado.getText().trim()+"','"+txtApellido_empleado.getText().trim()+"',"+Double.parseDouble(txtSueldo_empleado.getText().trim())+",null)";
                obj.ingresarDatos(estSQL1, sentenciaSQL);
            }
            else
            {
